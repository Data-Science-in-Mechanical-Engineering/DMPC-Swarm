...
// For emergency stop. Code in _dsme_emergencystop.h and _dsme_emergencystop.c
#define EM_STOP_TASK_PRI 6
#define TRAJ_INT_PRI 4
#define CPS_SWARM_PRI 3
#define SPI_SLAVE_TASK_PRI 5
...
// For emergency stop. Code in _dsme_emergencystop.h and _dsme_emergencystop.c
#define EM_STOP_TASK_NAME "EMERGENCY STOP"
#define TRAJ_INT_NAME       "TRAJ INT"
#define CPS_SWARM_NAME "CPS SWARM"
#define SPI_SLAVE_TASK_NAME "SPI SLAVE"
...
// For emergency stop. Code in _dsme_emergencystop.h and _dsme_emergencystop.c
#define EM_STOP_TASK_STACKSIZE configMINIMAL_STACK_SIZE
// for trajectory interpolation
#define TRAJ_INT_TASK_STACKSIZE (10*configMINIMAL_STACK_SIZE)
#define CPS_SWARM_TASK_STACKSIZE (2*configMINIMAL_STACK_SIZE)
#define SPI_SLAVE_TASK_STACKSIZE (40*configMINIMAL_STACK_SIZE)
