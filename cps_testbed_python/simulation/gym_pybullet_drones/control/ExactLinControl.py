...
from simulation.gym_pybullet_drones.control.BaseControl import BaseControl
from simulation.gym_pybullet_drones.envs.BaseAviary import DroneModel, BaseAviary
...
class DSLPIDControl(BaseControl):
	...
	def computeControl(self,
		...
		# calculate current angualr velocity in body fixed coordinates
