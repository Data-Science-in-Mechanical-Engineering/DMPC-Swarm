...
def define_ARGS():
    ...
    parser.add_argument("--show_animation", default=False,
                        type=bool,
    ...
    ARGS.setpoint_creator = sc.SetpointCreator(ARGS.drones, ARGS.testbeds, demo_setpoints=sc.NICE_FORMATIONS_DEMO)
