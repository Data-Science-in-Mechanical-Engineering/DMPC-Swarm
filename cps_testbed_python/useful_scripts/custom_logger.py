...
from simulation.gym_pybullet_drones.utils.Logger import Logger
...
class CustomLogger(Logger):
    ...
    def log_position(self, ID, time, position, control_position):
        ...
        self.__control_positions[ID].append(control_position)
        self.__times[ID].append(time)

    def log_calc_time(self, calc_time):
        self.calc_times.append(calc_time)

    def log_num_constraints(self, num_constraints):
        self.num_constraints.append(num_constraints)
