...
if __name__ == "__main__":
	...
	trajectory_message_size = 2+2*45+2*9+2+1+1
	print(trajectory_message_size)
	message_list = [state_message_size, state_message_size, state_message_size, state_message_size, state_message_size, state_message_size, trajectory_message_size, trajectory_message_size]
